...
class WorkshopCreatePurchase(models.TransientModel):
    _name = 'create.workshop.purchase'
    _description = "Create Purchase Order"

    partner_id = fields.Many2one('res.partner', string='Vendor', required=True)
    origin = fields.Char(string='Origin', readonly=True)
    order_line_ids = fields.One2many('create.workshop.purchase.line', 'order_line_id', String="Order Line")
...
class CreateOrderLine(models.TransientModel):
    _name = 'create.workshop.purchase.line'
    _description = "Create Purchase Order Line"

    order_line_id = fields.Many2one('create.workshop.purchase')
